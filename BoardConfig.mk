DEVICE_TREE := device/samsung/hero2qltedcm
...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_hero2qlte_dcm
...
# Samsung encryption as we are missing msm8996 keystore support
...
TARGET_INIT_VENDOR_LIB := libinit_hero2qltedcm
TARGET_RECOVERY_DEVICE_MODULES := libinit_hero2qltedcm
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_hero2qltedcm.cpp
